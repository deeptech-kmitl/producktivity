...
export const Card = component$((item: PricingCard) => {
  ...
  return (
    <div class={['relative shadow-md rounded-md grid grid-row-10 justify-between p-6 w-1/4 max-w-1/4 items-center', item.type === 'Professional' ? 'border-4 border-tertiary h-4/5 max-h-full' : 'h-4/5 max-h-4/5']}>
