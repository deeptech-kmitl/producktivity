 ...
 */
export async function renderResponse(request: Request, env: Record<string, unknown>, RootNode: unknown, manifest: QwikManifest, containerTagName?: string) {
...
class SimpleStreamWriter implements StreamWriter {
  ...
  write(chunk: string) {
    this.writer.write(typeof chunk === 'string' ? this.encoder.encode(chunk) : chunk);
  }
